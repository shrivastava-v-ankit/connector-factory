...
class Mysql(Decorator):
    ...
    def validate_config(self):
        ...
        logger.info("Validating the paylod for the MySql/MariaDb connection")
        message = ""
        ...
        if not self.is_valid:
            ...
            if not port:
                message = f"{message}Port is not provided will use default port as 3306.{os.linesep}"
    ...
    def create_uri(self):
        super().create_uri()
        logger.info("Call for creating the URI for MySql/MariaDb")
        ...
        if is_valid:
            ...
            logger.info("URI created for MySql/MariaDb")
